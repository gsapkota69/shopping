...
if (isset($_POST['updateMovies'])) {
    ...
    $images = $_POST['images'];
    $price  = $_POST['price'];
    $sql    = "UPDATE `product-details` SET `name` = '$name', `images` = '$images', `price` = '$price' WHERE `product-details`.`id` = '$id'";
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        value="<?php echo ($movie_data['name']); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="images" class="form-control"
                                        value="<?php echo ($movie_data['images']); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price" class="form-control"
                                        value="<?php echo ($movie_data['price']); ?>">
                                </div>
                            </div>
